...
const PostForm = ({ title, setTitle, content, setContent, editingPostId = null, onSubmit }) => {
    return (
        <div className='w-xl h-full flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col w-full'>
                ...
                <button onClick={onSubmit} className='border transition-all rounded-full mt-4 py-2'>{editingPostId ? 'Update Post' : 'Create Post'}</button>
            </div>
        </div>
    )
}
